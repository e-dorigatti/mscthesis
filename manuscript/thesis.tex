...
In this section, we present the evaluation metrics obtained by the estimators on the different configurations of features and data. We will refer to the interval $-2\leq\xi\leq1$ as the \emph{MOST validity range}; the proportion of data falling in this interval is 83.6\%. Unless specified otherwise, the metrics are presented as the mean over the ten outer validation folds and the standard deviation in parenthesis.
...
MSE & 0.6720 (0.03132)  & 0.3321  (0.0172)     \\
$R^2$ & 0.7055 (0.0089) & 0.6050 (0.0107)       \\
MAE & 0.5406 (0.0139) & 0.3954 (0.0072)      \\
mAE & 0.3716 (0.0156) & 0.2827 (0.0043)      \\
MAPE & 252.9254 (196.0861) & 184.7077 (48.2603)    \\
mAPE & 28.9648 (0.9388) & 24.6184    (0.7296)   \\
\bottomrule
\end{tabular}
\end{table}
