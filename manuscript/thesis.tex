...
\trita{TRITA-EECS-EX-2018:469}
\begin{document}


\includepdf[pages=1]{kth-cover8182536784857513235.pdf}
...
\For{$k_o\gets 1\ldots K_O$}\Comment{Outer $K_O$-fold cross validation}
	\State{Generate $k_o$-th outer fold $(D^o_T,D^o_V)$ from the dataset $\mathcal{D}$}
...
\includepdf[pages=2]{kth-cover8182536784857513235.pdf}
