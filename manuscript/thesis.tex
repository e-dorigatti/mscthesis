...
In the following, all the effect sizes are reported as a right 95\% confidence interval "$[\hat{\delta}_{low}, \hat{\delta}$", in bold when it does not contain 0.
...
\begin{figure}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        ...
        \caption{Scatterplot showing predicted value versus true value, MSE=0.155 and $R^2=0.803$}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        ...
        \caption{Probability plot of the residuals and normal fit, $R^2=0.850$ and Shapiro-Wilk's $W=0.850$}
