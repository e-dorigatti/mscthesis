...
\blurb{Master's Thesis at KTH Information and Communication Technology\\Supervisor: Gunilla Svennson\\Examiner: Jim Dowling}
...
In the appendixes, we outline some experiments that were performed, and could form the basis for a more advanced application of Machine Learning to the prediction of the momentum flux-profile relationship. Appendix \ref{apx:deep_learning} approaches the problem using deep neural networks, appendix \ref{apx:linear_ensemble} uses an ensemble of linear models, and appendix \ref{apx:hyperopt} uses more advanced hyper-parameters optimization techniques.
