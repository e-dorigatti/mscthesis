...
%        \caption{The treatment has standard deviation of 0255, and the effect size is 7.77}
		\label{fig:large_es}
    \end{subfigure}
    \caption{Graphical explanation of why the effect size is normalized with the standard deviation of the treatment, when the control has a mean of 0 and standard deviation of 1 and the treatment has a mean of 2; inarguably, the treatment in the right figure the best of the two.}
...
\begin{table}
\caption{Best MSE achieved by each estimator, and effect size comparing it with the MOST baseline (positive effect size denotes improvement, in the 95\% confidence interval is in parenthesis)}
...
\begin{table}
\caption{Effect sizes and their 95\% confidence interval comparing the MSE scores of each feature set with the previous set (i.e. F2 is compared with F1, F3 with F2, and so on). A positive effect size indicates that the feature set has a lower error than the previous one.}
...
\begin{table}
\caption{Effect sizes and their 95\% confidence interval comparing the MSE scores of each feature set with and without trend. A positive effect size indicates that the trend reduces the error.}
