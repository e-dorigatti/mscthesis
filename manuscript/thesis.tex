...
\textbf{LE} & 74.76 & 114.18 & -392.71 & -5.02& 23.92 & 132.66 & 748.69 \\
\textbf{$u_*$} & 0.31 & 0.15 & 0.10 & 0.20 & 0.28 & 0.39 & 1.55 \\
\textbf{Wind} & 5.86 & 2.66 & 1.00 & 3.96 & 5.43 & 7.23 & 29.10 \\
...
\textbf{Rain} & 0.02 & 0.12 & -0.02 & 0.00 & 0.00 & 0.00 & 15.10 \\
...
todo describe tsne
 - tsne fitted on standardized features, shown in table col_summary
 - fitted on the same 250k samples that are shown (also outside of most validity region)
 - the colors were obtained on the unscaled features, but discarding the top and bottom 1\%
...
\subcaptionbox{k-Means\label{fig:tsne_clus}}{\includegraphics[width=0.25\textwidth]{images/tsne_clus}}\hfill
    ...
    \caption{Results of the t-SNE dimensionality reduction algorithm applied to 250 000 samples (19.2\% of the total). Every figure uses a different feature to color the points (darker points have smaller values), except figure \ref{fig:tsne_clus}, where the colors represent the result of 2-means clustering (blue/orange) and 4-means clustering (the four shades). The colors are consistent, in the sense that light and dark shades of blue are placed in the same cluster by 2-means clustering, ditto for orange. (Best viewed in color)}
	\label{fig:tsne}
\end{figure}
