...
Figure \ref{fig:most_scatter} shows the wind shear versus the instability parameter, together with the commonly accepted flux-profile relationship in green and the relationship fitted on our dataset in red.
...
The performance of the MOST estimator is shown in table \ref{tbl:most_results}; the proportion of data for which $-2\leq\xi\leq 1$ is 83.6\%. We see a considerable increase in the MSE when the full dataset is used; this is not surprising, considering that, with $\xi>1$, $\phi_m$ tends to level off, and there are a considerable number of outliers in the range $-20\leq\xi\leq-2$ (see figure \ref{fig:most_full}) that cannot be fitted by the MOST estimator. Figure \ref{fig:most_scatter} shows $\phi_m$ as a function of $\xi$ as computed in our dataset, as well as the predictions of equation \ref{eq:phi_m_coeff} and the fitted MOST estimator. Qualitatively, the relationship behaves as expected, going to zero as $\xi$ decreases, linearly increasing in the $0\leq\xi\leq1$ interval, and leveling after that, possibly approaching the $\xi^{1/3}$ form proposed by \cite{sheba_phim}.
...
\begin{table}[]
\centering
\caption{Evaluation metrics for the MOST estimator}
\label{tbl:most_results}
%\begin{tabular*}{\textwidth}{r  |@{\extracolsep{\fill}}cc}
\begin{tabular}{r|cc}
\toprule
& All & $-2\le\xi\le1$ \\ \midrule
Mean Squared Error 					& 0.6720 (0.03132)  & 0.3321  (0.0172)     \\
$R^2$ Score									& 0.7055 (0.0089) & 0.6050 (0.0107)       \\
Mean Absolute Error 					& 0.5406 (0.0139) & 0.3954 (0.0072)      \\
Median Absolute Error 				& 0.3716 (0.0156) & 0.2827 (0.0043)      \\
Mean Absolute Percent Error  	& 252.9254 (196.0861) & 184.7077 (48.2603)    \\
Median Absolute Percent Error	& 28.9648 (0.9388) & 24.6184    (0.7296)   \\
\bottomrule
\end{tabular}
\end{table}
...
\subcaptionbox{Median Absolute Percent Error\label{fig:result_Ridge_most_median_abs_percent_error}}{\includegraphics[width=0.49\textwidth]{images/result_Ridge_most_median_abs_percent_error}}\\
    ...
    \caption{Evaluation metrics of the Ridge Regression Estimator in the MOST validity range; the feature sets with trend are blue, those without trend are green.}
...
\subcaptionbox{Median Absolute Percent Error\label{fig:result_Ridge_nomost_median_abs_percent_error}}{\includegraphics[width=0.49\textwidth]{images/result_Ridge_nomost_median_abs_percent_error}}\\
    ...
    \caption{Evaluation metrics of the Ridge Regression Estimator on all the data; the feature sets with trend are blue, those without trend are green.}
	\label{fig:ridge_results}
\end{figure}
...
\begin{figure}
\subcaptionbox{Mean Squared Error\label{fig:result_KNeighborsRegressor_most_mean_squared_error}}{\includegraphics[width=0.49\textwidth]{images/result_KNeighborsRegressor_most_mean_squared_error}}\hfill
\subcaptionbox{$R^2$ Score \label{fig:result_KNeighborsRegressor_most_r2_score}}{\includegraphics[width=0.49\textwidth]{images/result_KNeighborsRegressor_most_r2_score}}\\

\subcaptionbox{Mean Absolute Error\label{fig:result_KNeighborsRegressor_most_mean_absolute_error}}{\includegraphics[width=0.49\textwidth]{images/result_KNeighborsRegressor_most_mean_absolute_error}}
\subcaptionbox{Median Absolute Error\label{fig:result_KNeighborsRegressor_most_median_absolute_error}}{\includegraphics[width=0.49\textwidth]{images/result_KNeighborsRegressor_most_median_absolute_error}}\\

\subcaptionbox{Mean Absolute Percent Error\label{fig:result_KNeighborsRegressor_most_mean_abs_percent_error}}{\includegraphics[width=0.49\textwidth]{images/result_KNeighborsRegressor_most_mean_abs_percent_error}}\hfill
\subcaptionbox{Median Absolute Percent Error\label{fig:result_KNeighborsRegressor_most_median_abs_percent_error}}{\includegraphics[width=0.49\textwidth]{images/result_KNeighborsRegressor_most_median_abs_percent_error}}\\

    \caption{Evaluation metrics of the k-Nearest Neighbors Regressor Estimator in the MOST validity range; the feature sets with trend are blue, those without trend are green.}
	\label{fig:knn_results}
\end{figure}


\begin{figure}
\subcaptionbox{Mean Squared Error\label{fig:result_KNeighborsRegressor_nomost_mean_squared_error}}{\includegraphics[width=0.49\textwidth]{images/result_KNeighborsRegressor_nomost_mean_squared_error}}\hfill
\subcaptionbox{$R^2$ Score \label{fig:result_KNeighborsRegressor_nomost_r2_score}}{\includegraphics[width=0.49\textwidth]{images/result_KNeighborsRegressor_nomost_r2_score}}\\

\subcaptionbox{Mean Absolute Error\label{fig:result_KNeighborsRegressor_nomost_mean_absolute_error}}{\includegraphics[width=0.49\textwidth]{images/result_KNeighborsRegressor_nomost_mean_absolute_error}}
\subcaptionbox{Median Absolute Error\label{fig:result_KNeighborsRegressor_nomost_median_absolute_error}}{\includegraphics[width=0.49\textwidth]{images/result_KNeighborsRegressor_nomost_median_absolute_error}}\\

\subcaptionbox{Mean Absolute Percent Error\label{fig:result_KNeighborsRegressor_nomost_mean_abs_percent_error}}{\includegraphics[width=0.49\textwidth]{images/result_KNeighborsRegressor_nomost_mean_abs_percent_error}}\hfill
\subcaptionbox{Median Absolute Percent Error\label{fig:result_KNeighborsRegressor_nomost_median_abs_percent_error}}{\includegraphics[width=0.49\textwidth]{images/result_KNeighborsRegressor_nomost_median_abs_percent_error}}\\

    \caption{Evaluation metrics of the k-Nearest Neighbors Regressor Estimator on all the data; the feature sets with trend are blue, those without trend are green.}
	\label{fig:knn_results}
\end{figure}
...
\input{include/results_KNeighborsRegressor}
\end{table}
...
\begin{figure}
\subcaptionbox{Mean Squared Error\label{fig:result_GradientBoostingRegressor_most_mean_squared_error}}{\includegraphics[width=0.49\textwidth]{images/result_GradientBoostingRegressor_most_mean_squared_error}}\hfill
\subcaptionbox{$R^2$ Score \label{fig:result_GradientBoostingRegressor_most_r2_score}}{\includegraphics[width=0.49\textwidth]{images/result_GradientBoostingRegressor_most_r2_score}}\\

\subcaptionbox{Mean Absolute Error\label{fig:result_GradientBoostingRegressor_most_mean_absolute_error}}{\includegraphics[width=0.49\textwidth]{images/result_GradientBoostingRegressor_most_mean_absolute_error}}
\subcaptionbox{Median Absolute Error\label{fig:result_GradientBoostingRegressor_most_median_absolute_error}}{\includegraphics[width=0.49\textwidth]{images/result_GradientBoostingRegressor_most_median_absolute_error}}\\

\subcaptionbox{Mean Absolute Percent Error\label{fig:result_GradientBoostingRegressor_most_mean_abs_percent_error}}{\includegraphics[width=0.49\textwidth]{images/result_GradientBoostingRegressor_most_mean_abs_percent_error}}\hfill
\subcaptionbox{Median Absolute Percent Error\label{fig:result_GradientBoostingRegressor_most_median_abs_percent_error}}{\includegraphics[width=0.49\textwidth]{images/result_GradientBoostingRegressor_most_median_abs_percent_error}}\\

    \caption{Evaluation metrics of the Gradient Boosted Trees Estimator in the MOST validity range; the feature sets with trend are blue, those without trend are green.}
	\label{fig:gbr_results}
\end{figure}

todo add plots for gbr nomost


\begin{table}[]
\caption{Evaluation metrics for the Gradient Boosted Trees Estimator estimator.}
\label{tbl:gbr_results}
\input{include/results_GradientBoostingRegressor}
\end{table}
